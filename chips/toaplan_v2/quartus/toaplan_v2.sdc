# =============================================================================
# Toaplan V2 — Timing Constraints (SDC)
# =============================================================================
#
# Timing constraints for Toaplan V2 MiSTer core on DE-10 Nano (Cyclone V)
#
# System clock: 32 MHz (from PLL; MC68000 clock-enable = sys_clk / 2 = 16 MHz)
...
# ==========================================================================
#
# Toaplan V2 operates in multiple asynchronous clock domains:
#   — sys_clk (32 MHz): CPU, GP9001, palette RAM, work RAM
...
#
# Toaplan V2 system clock: 32 MHz
...
#   GP9001      : 32 MHz / 2 CE → 2-cycle multicycle
# =============================================================================
...
# GP9001 graphics chip — 32 MHz / 2 CE
set_multicycle_path -from [get_registers {*u_gp9001*}] -to [get_registers {*u_gp9001*}] -setup 2
set_multicycle_path -from [get_registers {*u_gp9001*}] -to [get_registers {*u_gp9001*}] -hold  1
