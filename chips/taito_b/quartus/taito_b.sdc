# =============================================================================
# Taito B — Timing Constraints (SDC)
# =============================================================================
#
# Timing constraints for Taito B MiSTer core on DE-10 Nano (Cyclone V)
#
# System clock: 16 MHz (from PLL; CPU clock-enable = sys_clk / 2 = 8 MHz)
# Pixel clock:  8 MHz (sys_clk / 2 CE from TC0180VCU)
...
# These include sys_clk (16 MHz), sdram_clk (143 MHz), HDMI clocks, audio clocks.
derive_pll_clocks
...
#
# Taito B system clock: 16 MHz
#   MC68000 CPU : 16 MHz / 2 =  8 MHz  → 2-cycle multicycle
#   Z80 sound   : 16 MHz / 4 =  4 MHz  → 4-cycle multicycle
#   YM2610 FM   : very slow → false path
#   TC0180VCU   : 16 MHz / 2 CE → 2-cycle multicycle
# =============================================================================
...
# Z80 sound CPU — 16 MHz / 4 = 4 MHz (4-cycle multicycle)
...
# TC0180VCU graphics chip — 16 MHz / 2 CE
set_multicycle_path -from [get_registers {*u_vcu*}] -to [get_registers {*u_vcu*}] -setup 2
set_multicycle_path -from [get_registers {*u_vcu*}] -to [get_registers {*u_vcu*}] -hold  1
