-- MAME RAM dump script for birdtry (DECO 16-bit)
-- Auto-generated from MAME dataeast/dec0.cpp
-- Usage: mame birdtry -autoboot_script dump_birdtry.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'birdtry_%05d.bin', frame_count)
...
print("Dump script loaded for birdtry — will dump " .. MAX_FRAMES .. " frames")