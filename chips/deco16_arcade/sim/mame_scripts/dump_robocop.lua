-- MAME RAM dump script for robocop (DECO 16-bit)
-- Auto-generated from MAME dataeast/dec0.cpp
-- Usage: mame robocop -autoboot_script dump_robocop.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'robocop_%05d.bin', frame_count)
...
print("Dump script loaded for robocop — will dump " .. MAX_FRAMES .. " frames")