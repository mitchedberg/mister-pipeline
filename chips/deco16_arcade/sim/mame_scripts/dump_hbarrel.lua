-- MAME RAM dump script for hbarrel (DECO 16-bit)
-- Auto-generated from MAME dataeast/dec0.cpp
-- Usage: mame hbarrel -autoboot_script dump_hbarrel.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'hbarrel_%05d.bin', frame_count)
...
print("Dump script loaded for hbarrel — will dump " .. MAX_FRAMES .. " frames")