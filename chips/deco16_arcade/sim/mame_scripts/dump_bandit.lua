-- MAME RAM dump script for bandit (DECO 16-bit)
-- Auto-generated from MAME dataeast/dec0.cpp
-- Usage: mame bandit -autoboot_script dump_bandit.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'bandit_%05d.bin', frame_count)
...
print("Dump script loaded for bandit — will dump " .. MAX_FRAMES .. " frames")