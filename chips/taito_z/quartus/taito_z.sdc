# =============================================================================
# Taito Z — Timing Constraints (SDC)
# =============================================================================
#
# Timing constraints for Taito Z MiSTer core on DE-10 Nano (Cyclone V)
#
# System clock: 32 MHz (from PLL; CPU clock-enable = sys_clk / 2 = 16 MHz)
# Pixel clock:  16 MHz (sys_clk / 2 CE from TC0480SCP)
...
# ==========================================================================
#
# Taito Z operates in multiple asynchronous clock domains:
#   — sys_clk (32 MHz): CPU, TC0480SCP, TC0150ROD, TC0370MSO, TC0510NIO
