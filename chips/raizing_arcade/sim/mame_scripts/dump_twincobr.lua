-- MAME RAM dump script for twincobr (Raizing)
-- Auto-generated from MAME toaplan/twincobr.cpp
-- Usage: mame twincobr -autoboot_script dump_twincobr.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'twincobr_%05d.bin', frame_count)
...
print("Dump script loaded for twincobr — will dump " .. MAX_FRAMES .. " frames")