-- MAME RAM dump script for gulfwar2 (Raizing)
-- Auto-generated from MAME toaplan/twincobr.cpp
-- Usage: mame gulfwar2 -autoboot_script dump_gulfwar2.lua -nothrottle -str 3000
...
emu.register_frame_done(function()
    ...
    local fname = string.format(DUMP_DIR .. 'gulfwar2_%05d.bin', frame_count)
...
print("Dump script loaded for gulfwar2 — will dump " .. MAX_FRAMES .. " frames")