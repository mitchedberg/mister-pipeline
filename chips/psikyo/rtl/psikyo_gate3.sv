...
module psikyo_gate3 (
    ...
    input  logic [2559:0]      display_list_x,       // [255:0]×[9:0]  flat
    input  logic [2559:0]      display_list_y,       // [255:0]×[9:0]  flat
    input  logic [4095:0]      display_list_tile,    // [255:0]×[15:0] flat
    input  logic [1023:0]      display_list_palette, // [255:0]×[3:0]  flat
    input  logic [255:0]       display_list_flip_x,
    input  logic [255:0]       display_list_flip_y,
    input  logic [511:0]       display_list_priority,// [255:0]×[1:0]  flat
    input  logic [767:0]       display_list_size,    // [255:0]×[2:0]  flat
            ...
            case (g3_state)
                ...
                G3_CHECK: begin
                    if (g3_spr_idx >= display_list_count) begin
                        ...
                        begin
                            automatic logic [9:0]  e_y      = display_list_y   [g3_spr_idx*10 +: 10];
                            automatic logic [9:0]  e_x      = display_list_x   [g3_spr_idx*10 +: 10];
                            automatic logic [15:0] e_tile   = display_list_tile [g3_spr_idx*16 +: 16];
                            automatic logic        e_flip_x = display_list_flip_x[g3_spr_idx];
                            automatic logic        e_flip_y = display_list_flip_y[g3_spr_idx];
                            automatic logic [2:0]  e_size   = display_list_size [g3_spr_idx*3  +:  3];
                            automatic logic [3:0]  e_pal    = display_list_palette[g3_spr_idx*4 +: 4];
                            automatic logic [1:0]  e_prio   = display_list_priority[g3_spr_idx*2 +: 2];
