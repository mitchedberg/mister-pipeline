...
module psikyo (
  ...
  // Flat 1D ports — avoids Quartus 17 Error 10028 (<auto-generated> nets on packed 2D ports).
  // Element N occupies bits [(N+1)*W-1 : N*W].
  output logic [2559:0]        display_list_x,       // [255:0]×[9:0]  flat
  output logic [2559:0]        display_list_y,       // [255:0]×[9:0]  flat
  output logic [4095:0]        display_list_tile,    // [255:0]×[15:0] flat
  ...
  output logic [511:0]         display_list_priority,// [255:0]×[1:0]  flat
  output logic [767:0]         display_list_size,    // [255:0]×[2:0]  flat
  ...
  generate
    ...
    for (k = 0; k < 256; k++) begin : display_list_assign
      assign display_list_x[k*10 +: 10]   = display_list_internal[k].x;
      assign display_list_y[k*10 +: 10]   = display_list_internal[k].y;
      assign display_list_tile[k*16 +: 16] = display_list_internal[k].tile_num;
      assign display_list_palette[k*4 +: 4] = display_list_internal[k].palette;
      assign display_list_flip_x[k]        = display_list_internal[k].flip_x;
      assign display_list_flip_y[k]        = display_list_internal[k].flip_y;
      assign display_list_priority[k*2 +: 2] = display_list_internal[k].prio;
      assign display_list_size[k*3 +: 3]   = display_list_internal[k].size;
